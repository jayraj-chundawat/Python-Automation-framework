...
class APIClient:
    ...
    def get(self, endpoint, params=None, headers=None):
        ...
        self.logger.info(f"GET Response: {response.status_code}, Body: {response.text[:200]}")
        return response
    ...
    def post(self, endpoint, data=None, json_data=None, headers=None):
        ...
        self.logger.info(f"POST Response: {response.status_code}, Body: {response.text[:200]}")
        return response
    ...
    def put(self, endpoint, json_data=None, headers=None):
        ...
        self.logger.info(f"PUT Response: {response.status_code}, Body: {response.text[:200]}")
        return response
    ...
    def delete(self, endpoint, headers=None):
        ...
        self.logger.info(f"DELETE Response: {response.status_code}, Body: {response.text[:200]}")
        return response
